...
# (project=scitex-capture, owner=ywatanabe1989, repo=scitex-capture,
...
TMPDIR="/tmp/publish-scitex_capture-${GITHUB_RUN_ID:-0}-${GITHUB_RUN_ATTEMPT:-0}-$V"
export TMPDIR
rm -rf "$TMPDIR"
...
echo "PUBLISH-OK: scitex-capture dist/* uploaded to PyPI via manual OIDC trusted publishing"
